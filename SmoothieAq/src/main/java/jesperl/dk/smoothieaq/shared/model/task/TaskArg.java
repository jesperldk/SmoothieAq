...
public abstract class  TaskArg extends DbObject implements TaskArg_HelperInheritace, TaskArg_Helper { 
	@JsonIgnore public transient String $type; 


	@JsOverlay public final TaskArg copy() { return TaskArg_HelperInheritace.$copy( this ); }
